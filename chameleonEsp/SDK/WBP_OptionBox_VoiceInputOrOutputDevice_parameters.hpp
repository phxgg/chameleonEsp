...
public:
	...
	bool                                          CallFunc_Array_RemoveItem_ReturnValue;             // 0x00D4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<struct FRedpointVoiceChatAudioDevice>  CallFunc_GetAvailableVoiceChatAudioDevices_ReturnValue; // 0x00D8(0x0010)(ReferenceParm)
	struct FRedpointVoiceChatAudioDevice          CallFunc_Array_Get_Item_1;                         // 0x00E8(0x0028)()
	...
	struct FRedpointVoiceChatAudioDevice          CallFunc_GetVoiceChatAudioOutputDevice_ReturnValue; // 0x0170(0x0028)()
	struct FRedpointVoiceChatAudioDevice          CallFunc_GetVoiceChatAudioInputDevice_ReturnValue; // 0x0198(0x0028)()
	struct FRedpointVoiceChatAudioDevice          K2Node_Select_Default;                             // 0x01C0(0x0028)()
	int32                                         CallFunc_Array_Find_ReturnValue;                   // 0x01E8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_Clamp_ReturnValue;                        // 0x01EC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_SetOptionIndex_ReturnValue;               // 0x01F0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
