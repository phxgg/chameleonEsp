...
public:
	...
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_FirstPersonCharacter_cLeon_Character_Survivor_C; // 0x0CF8(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
